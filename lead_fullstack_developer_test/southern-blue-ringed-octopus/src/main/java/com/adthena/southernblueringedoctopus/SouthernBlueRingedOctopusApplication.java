...
import com.adthena.southernblueringedoctopus.api.CategoryResource;
import com.adthena.southernblueringedoctopus.api.DateResource;
import com.adthena.southernblueringedoctopus.api.EventResource;
import com.adthena.southernblueringedoctopus.api.VenueResource;
...
public class SouthernBlueRingedOctopusApplication
    extends Application<SouthernBlueRingedOctopusConfiguration> {

  public static void main(String[] args) throws Exception {
    new SouthernBlueRingedOctopusApplication().run(args);
  }

  @Override
  public void initialize(final Bootstrap<SouthernBlueRingedOctopusConfiguration> bootstrap) {
  ...
  @Override
  public void run(
      final SouthernBlueRingedOctopusConfiguration configuration,
